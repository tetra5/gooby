...
if __name__ == "__main__":
    setup(name="gooby",
          ...
          requires=["Skype4Py (>=1.0.32)", "lxml (>=2.3.2)"],
          provides=["gooby"],
          long_description="""Gooby is a modular plugin-based Skype bot built
on top of Skype4Py Skype API wrapper written completely in Python.""",
          packages=["gooby", "gooby.plugins"],
          package_dir={"gooby": "src",
