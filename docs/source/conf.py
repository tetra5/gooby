...
latex_documents = [('index', 'goobydoc.tex', u'Gooby Documentation', u'tetra5', 'manual')]
...
man_pages = [('index', 'goobydoc', u'Gooby Documentation', [u'tetra5'], 1)]
